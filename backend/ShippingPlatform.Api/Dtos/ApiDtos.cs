...
public record ShipmentDto(int Id, string RefCode, string? TiiuCode, int OriginWarehouseId, int DestinationWarehouseId, DateTime PlannedDepartureDate, DateTime PlannedArrivalDate, DateTime? ActualDepartureAt, DateTime? ActualArrivalAt, ShipmentStatus Status, decimal MaxWeightKg, decimal MaxVolumeM3, decimal TotalWeightKg, decimal TotalVolumeM3, string? ExternalTrackingCode, string? ExternalCarrierName, string? ExternalOrigin, string? ExternalDestination, DateTime? ExternalEstimatedArrivalAt, string? ExternalStatus, DateTime? ExternalLastSyncedAt, DateTime CreatedAt);
public record CreateShipmentRequest(int OriginWarehouseId, int DestinationWarehouseId, DateTime PlannedDepartureDate, DateTime PlannedArrivalDate, decimal MaxWeightKg = 0, decimal MaxVolumeM3 = 0, string? TiiuCode = null);
